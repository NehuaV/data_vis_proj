...
\begin{paracol}{1}
    \centering
    \includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{../out/5_apple_revenue_black_and_white.pdf}
...
\begin{paracol}{1}
    \centering
    \includegraphics[width=0.80\linewidth,height=0.80\textheight,keepaspectratio]{../out/europe_full_cartogram.pdf}
    \captionof{figure}{Cartogram of population density in Europe (People per km²)}
\end{paracol}
...
% First image on its own page
\begin{paracol}{1}
    \centering
    \includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{../out/11_interactive_unemployment_1.png}
    \captionof{figure}{Screenshot of interactive European unemployment visualization for year 2024 (view 1)}
\end{paracol}

\clearpage

% Second image with description below
\begin{paracol}{1}
    \centering
    \includegraphics[width=0.95\linewidth,height=0.80\textheight,keepaspectratio]{../out/11_interactive_unemployment_2.png}
    \captionof{figure}{Screenshot of interactive European unemployment visualization for year 1996 (view 2)}
    
    % Description below both images
    \vspace{1.5em}
    \raggedright
...
% --- TASK 12 ---
\tasktitle{12: Visualization Creation Process Documentation (Task 11: Interactive Visualization)}
...
\begin{paracol}{2}
    ...
    After all of that, I decided to make the map interactive by adding a slider 
    that allows you to see how unemployment rates change from year to year. 
    This lets users explore temporal trends easily, making the visualization much more insightful and engaging.
...
\begin{paracol}{1}
    % LEFT COLUMN
    \centering
    \includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{../out/13_word_cloud_tags.pdf}
...
\begin{paracol}{1}
    % LEFT COLUMN
    \centering
    \includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{../out/13_movie_count_genre.pdf}
...
\begin{itemize}
    ...
    \item Libraries: Pandas, Seaborn, Matplotlib, Geopandas, Cartogram, Plotly, Streamlit.
\end{itemize}
